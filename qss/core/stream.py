...
def stream_generator(arrival_rate, service_rate, num_jobs=None, time_limit=None):
    """
    ...
    @param service_rate: Service rate for jobs.
    ...
    while num_jobs or (time_limit and next_arrival_timestamp < time_limit):
        ...
        yield Job(service_time=get_random(service_rate),
